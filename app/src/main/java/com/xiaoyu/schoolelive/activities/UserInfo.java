        ...
        public void handleMessage(Message msg) {
            ...
            switch (index){
                case 0://初始化
                    ...
                    user_cache.setReal_name(real_name);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                User user = User_cache.get_user_info_Cache(UserInfo.this);
                                user.setName(str);
                                User_cache.set_user_info_Cache(UserInfo.this,user);
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (sex_status == -1) {
                                    ...
                                    User user = User_cache.get_user_info_Cache(UserInfo.this);
                                    user.setSex(String.valueOf(sex_status));
                                    User_cache.set_user_info_Cache(UserInfo.this,user);
                                    RequestBody requestBody = new FormBody.Builder()
                                            .add("uid", String.valueOf(uid))//uid
                                            .add("field","sex")//字段
...
//                break;
    ...
    public void uploadMultiFile(String uid, File file) {//将图片发送到服务器,一张图片(处理头像)
